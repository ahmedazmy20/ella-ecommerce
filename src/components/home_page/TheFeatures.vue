      ...
      <v-row>
        <v-col cols="12" md="4">
          <div class="d-flex justify-center align-center ga-2">
            ...
            >
              <defs>
                <linearGradient
                  ...
                  y2="100%"
                >
                  <stop offset="0%" stop-color="#0000"></stop>
            ...
            <span class="test">{{ $t("home.Free-Shipping") }}</span>
          </div>
        </v-col>
        <v-col cols="12" md="4">
          <div class="content d-flex justify-center align-center ga-2">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
            ...
            <span class="test">{{ $t("home.Lowest-Price") }}</span>
          </div>
        </v-col>
        <v-col cols="12" md="4">
          <div class="d-flex justify-center align-center ga-2">
            ...
            <span class="test">{{ $t("home.Longest-Warranties") }}</span>
          </div>
        </v-col>
      </v-row>
    </v-container>
...
.content {
  ...
  &::after {
    ...
    width: 1px;
    height: 100%;
    background-color: rgba(66, 66, 66, 0.607);
  }
  &::before {
    content: "";
    position: absolute;
...
.test {
  ...
  &::after {
    ...
    width: 0%;
    height: 10%;
    background-color: rgba(252, 13, 0, 0.607);
  ...
  &:hover {
    &::after {
      ...
      width: 100%;
      height: 10%;
      background-color: rgba(25, 71, 255, 0.607);
    }
  }
}
</style>
